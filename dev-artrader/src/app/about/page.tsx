  ...
  return (
    <div className="max-w-[1400px] mx-auto px-6 md:px-12">
      ...
      <section className="py-20 md:py-28 text-center">
        <Link
          href="/"
          className="inline-flex items-center gap-2 px-4 py-2 mb-10 bg-[#111] border border-[#2a2a2a] rounded-lg text-sm text-[#888] hover:text-[#4ade80] hover:border-[#4ade80]/30 transition-all"
        >
