...
export const artists: Artist[] = [
  {
    ...
    recentAuctions: [
      { title: "From Line No. 800152", year: 1980, medium: "Oil and mineral pigment on canvas", size: "218×291cm", hammer: "₩4,200,000,000", auctionHouse: "서울옥션", date: "2024.11", imageUrl: "/images/exhibitions/between-lines/between-lines-1.jpg" },
      { title: "Dialogue", year: 2018, medium: "Oil and mineral pigment on canvas", size: "162×130cm", hammer: "₩1,850,000,000", auctionHouse: "케이옥션", date: "2024.09", imageUrl: "/images/exhibitions/between-lines/between-lines-2.jpg" },
      { title: "From Point No. 780217", year: 1978, medium: "Oil and mineral pigment on canvas", size: "182×227cm", hammer: "₩3,100,000,000", auctionHouse: "Christie's", date: "2024.05", imageUrl: "/images/exhibitions/between-lines/between-lines-3.jpg" },
      { title: "Relatum", year: 2015, medium: "Steel and stone", size: "130×180×45cm", hammer: "₩920,000,000", auctionHouse: "필립스", date: "2024.03", imageUrl: "/images/exhibitions/between-lines/between-lines-4.jpg" },
      { title: "Correspondence", year: 2006, medium: "Oil and mineral pigment on canvas", size: "130×162cm", hammer: "₩780,000,000", auctionHouse: "서울옥션", date: "2023.12", imageUrl: "/images/exhibitions/between-lines/between-lines-5.jpg" },
    ],
  ...
  },
  {
    ...
    recentAuctions: [
      { title: "05-IV-71 #200 (Universe)", year: 1971, medium: "Oil on cotton", size: "254×202cm", hammer: "₩13,160,000,000", auctionHouse: "Christie's", date: "2019.11", imageUrl: "/images/exhibitions/color-spectrum/color-spectrum-1.jpg" },
      { title: "Untitled 12-V-70 #172", year: 1970, medium: "Oil on cotton", size: "236×173cm", hammer: "₩8,500,000,000", auctionHouse: "서울옥션", date: "2024.06", imageUrl: "/images/exhibitions/color-spectrum/color-spectrum-2.jpg" },
      { title: "여인들과 항아리", year: 1950, medium: "Oil on canvas", size: "95×72cm", hammer: "₩4,700,000,000", auctionHouse: "케이옥션", date: "2024.03", imageUrl: "/images/exhibitions/color-spectrum/color-spectrum-3.jpg" },
    ],
  ...
  },
  {
    ...
    recentAuctions: [
      { title: "Ecriture No. 071220", year: 2007, medium: "Mixed media with Korean hanji paper on canvas", size: "195×130cm", hammer: "₩3,200,000,000", auctionHouse: "Christie's", date: "2024.10", imageUrl: "/images/exhibitions/silent-dialogue/silent-dialogue-1.jpg" },
      { title: "Ecriture(描法) No. 990505", year: 1999, medium: "Mixed media on canvas", size: "162×130cm", hammer: "₩1,450,000,000", auctionHouse: "서울옥션", date: "2024.06", imageUrl: "/images/exhibitions/silent-dialogue/silent-dialogue-2.jpg" },
    ],
    tags: ["단색화", "묘법", "현대미술", "추상"],
  },
  {
    ...
    recentAuctions: [
      { title: "Infinity Nets (TWOWQ)", year: 2005, medium: "Acrylic on canvas", size: "194×259cm", hammer: "₩7,800,000,000", auctionHouse: "Christie's", date: "2024.11", imageUrl: "/images/exhibitions/forest-of-finity/forest-of-finity-1.jpg" },
      { title: "Pumpkin", year: 2010, medium: "Acrylic on canvas", size: "130×130cm", hammer: "₩2,300,000,000", auctionHouse: "Sotheby's", date: "2024.08", imageUrl: "/images/exhibitions/forest-of-finity/forest-of-finity-2.jpg" },
    ],
  ...
  },
  {
    ...
    recentAuctions: [
      { title: "Untitled 2015-6-3", year: 2015, medium: "Acrylic on canvas", size: "230×230cm", hammer: "₩1,800,000,000", auctionHouse: "서울옥션", date: "2024.05", imageUrl: "/images/exhibitions/golden-reeds/golden-reeds-1.jpg" },
    ],
    tags: ["단색화", "현대미술", "추상"],
  },
  {
    ...
    recentAuctions: [
      { title: "Wright Brothers", year: 1995, medium: "2 antique TV cabinets, 2 Samsung monitors, 1 laser disc player", size: "153×183×61cm", hammer: "₩2,100,000,000", auctionHouse: "Christie's", date: "2024.09", imageUrl: "/images/exhibitions/sculpture-garden/sculpture-garden-1.jpg" },
    ],
  ...
  },
  {
    ...
    stats: { avgPrice: "₩210,000,000", totalTransactions: 389, hammerRate: "69.5%", annualGrowth: "+7.8%", highestPrice: "₩3,500,000,000" },
    recentAuctions: [
  ...
  },
  {
    ...
    education: ["홍익대학교 미술대학 회화과 졸업 (1959)"],
    exhibitions: [
  ...
  },
  {
    ...
    education: ["서울대학교 미술대학 동양화과 졸업 (1951)"],
    exhibitions: [
  ...
  },
  {
    ...
    education: ["서울대학교 미술대학 회화과 졸업 (1965)", "홍익대학교 대학원 미학 석사 (1972)"],
    exhibitions: ["국립현대미술관 회고전, 서울 (2019)", "서울시립미술관 개인전, 서울 (2021)", "광주비엔날레, 광주 (2018)"],
    stats: { avgPrice: "₩150,000,000", totalTransactions: 178, hammerRate: "68.9%", annualGrowth: "+9.2%", highestPrice: "₩1,800,000,000" },
    recentAuctions: [
  ...
  },
  {
    ...
    nationality: "한국",
    category: "현대미술",
    bio: "이왈종은 제주의 자연과 삶을 동양적 감성으로 풀어내는 한국의 대표적 수묵 채색화 작가입니다. '제주 생활의 중도' 시리즈로 널리 알려져 있습니다.",
    education: ["서울대학교 미술대학 동양화과 졸업 (1969)"],
    exhibitions: ["국립현대미술관 초대 개인전, 과천 (2009)", "제주도립미술관 개인전, 제주 (2016)", "갤러리현대 개인전, 서울 (2020)"],
    stats: { avgPrice: "₩120,000,000", totalTransactions: 345, hammerRate: "66.2%", annualGrowth: "+4.8%", highestPrice: "₩1,500,000,000" },
    recentAuctions: [
  ...
  },
  {
    ...
    education: ["독학 (City-as-School 고등학교 중퇴, 1978)"],
  ...
  },
  {
    ...
    nationality: "독일",
    category: "현대미술",
    bio: "게르하르트 리히터는 현존하는 가장 영향력 있는 작가 중 한 명으로, 포토리얼리즘부터 추상까지 다양한 양식을 넘나들며 회화의 본질과 가능성을 탐구해왔습니다.",
    education: ["드레스덴 미술 아카데미 졸업 (1956)", "뒤셀도르프 쿤스트아카데미 졸업 (1963)"],
  ...
  },
  {
    ...
    nationality: "영국",
    category: "현대미술",
    bio: "데이비드 호크니는 팝아트와 구상회화의 거장으로, 수영장 시리즈와 풍경화로 세계적 명성을 얻었습니다. 회화, 사진, 디지털 아트 등 다양한 매체를 실험합니다.",
    education: ["브래드퍼드 미술 대학 졸업 (1957)", "로열 컬리지 오브 아트 졸업 (1962)"],
