...
export const menuItems: MenuItem[] = [
  { label: "Home", href: "/" },
  {
    ...
    href: "/art-center",
    children: [
      { label: "Exhibitions", href: "/art-center/exhibitions" },
      { label: "Events", href: "/art-center/events" },
      { label: "Open Call", href: "/art-center/open-call" },
    ],
  },
  {
    label: "Artrader",
    href: "/artrader",
    children: [
      { label: "Platform", href: "/artrader/platform" },
      { label: "Artists", href: "/artrader/artists" },
    ],
  },
  {
    label: "Advisory",
    href: "/advisory",
    children: [
      { label: "Art Consulting", href: "/advisory/consulting" },
      { label: "Space Design", href: "/advisory/space-design" },
      { label: "Corporate Art", href: "/advisory/corporate-art" },
    ],
  },
  {
    label: "Spaces",
    href: "/spaces",
    children: [
      { label: "Gallery Rental", href: "/spaces/gallery" },
      { label: "Event Space", href: "/spaces/events" },
      { label: "Coworking", href: "/spaces/coworking" },
    ],
  },
  {
    label: "Community",
    href: "/community",
    children: [
      { label: "Art Salon", href: "/community/salon" },
...
export const feedCards: CardItem[] = [
  ...
  },
  {
    ...
    date: "Now Showing",
    tags: ["Exhibition"],
    image: "https://images.unsplash.com/photo-1578321272176-b7bbc0679853?w=900&q=80",
    href: "#",
    featured: true,
  },
  {
