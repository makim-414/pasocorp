...
const brands = [
  { name: "Artrader.io", image: "/images/exhibitions/reborn/reborn-1.jpg", color: "#b8960b", href: "https://artrader.io", enabled: true },
  { name: "Paso Gallery", image: "/brands/paso-gallery.png", color: "#1e3a5f", href: "https://pasogallery.com", enabled: true },
  { name: "Paso Agency", image: "/images/exhibitions/traces-of-light/traces-of-light-1.jpg", color: "#d4a574", href: "/brands/paso-agency", enabled: false },
