...
const BRANDS = [
  ...
  { title: "Gallery", subtitle: "Primary Art Market", content: "국내 신진작가 공모전, 글로벌 이머징 작가 전시. 예술의 최전선.", image: "/brands/paso-gallery.jpg", color: "#1e3a5f", cta: "EXPLORE" },
  { title: "Agency", subtitle: "IP & Brand Collaboration", content: "브랜드 아트 프로젝트, 캐릭터 IP 라이선싱, 아트토이.", image: "/brands/paso-agency.jpg", color: "#d4a574", cta: "EXPLORE" },
