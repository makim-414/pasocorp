...
function TripleFeature() {
  const cards = [
    { image: "/brands/paso-gallery-heritage.jpg", title: "Paso Private Sales", desc: "Paso Gallery의 프라이빗 세일", tall: false, href: "https://pasogallery.com" },
    ...
    { image: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=1920&q=90", title: "마곡 아트 살롱", desc: "월간 커뮤니티 아트 토크", tall: false, href: "/brands/paso-art-center" },
  ];
  const ref = useRef(null);
