...
export default function UserPage() {
  ...
  return (
    <div className="max-w-[1000px] mx-auto px-6 md:px-12 py-12">
      ...
      {/* Favorites shortcut */}
      <Link
        href="/artrader/favorites"
        className="flex items-center justify-between py-6 border-b border-[#1a1a1a] group"
      >
        <div className="flex items-center gap-3">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#4ade80" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
          </svg>
          <h2 className="text-lg font-normal text-white/90 group-hover:text-[#4ade80] transition-colors">관심작품</h2>
        </div>
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#666" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-[#4ade80] transition-colors">
