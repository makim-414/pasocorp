        ...
        <div className="max-w-[900px] mx-auto px-6 md:px-12 text-center">
          <motion.div {...fadeUp}>
            ...
            <div className="max-w-[680px] mx-auto space-y-6 text-left text-[#e5e5e5] font-normal text-base md:text-[17px]" style={{ wordBreak: "keep-all", overflowWrap: "break-word", lineHeight: 1.9 }}>
              <p>
                파소 갤러리는 서울 성북동 초입에 위치한 70년 전통 종가 한옥을 현대적으로 재해석한 현대미술 갤러리로, 지난 6여 년간 공모전에 의한 신진 작가 발굴과 글로벌 이머징 전시를 중심으로 다양한 확장적인 예술 프로젝트를 전개해왔습니다.
              </p>
              <p>
                파소는 단순한 갤러리를 넘어 전시, 브랜드 협업, 아트 IP, 데이터 기반 미술 자문까지 확장된 통합 아트 비즈니스를 구축하고 있습니다.
              </p>
              <p>
                또한 파소는 아트 데이터 플랫폼 ‘Artrader’, 브랜드·작가 협업을 위한 ‘Paso Agency’, 미술 자산 자문 서비스 등을 통해 예술을 문화 콘텐츠이자 전략적 자산으로 확장하고 있습니다. 데이터와 큐레이션, 공간과 커뮤니티를 연결하며 더 넓은 시장에서 동시대 미술 시장의 새로운 가능성을 만들어가고 있습니다.
              </p>
            </div>
